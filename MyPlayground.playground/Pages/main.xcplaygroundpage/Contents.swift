 ...
 */
// write your code here
func anyCharacter(characterName: String) {
    print("My favorite character is \(characterName)")
}
anyCharacter("Cinderella")
 ...
 */
// write your code here
let dumbledore = "Dumbledore"
var character = "Bender"
anyCharacter(dumbledore)
 ...
 */
// write your code here
func numberOfProblems (problems: Int) {
 ...
 */
// write your code here
func numFavBand(band: String, rank: Int) {
    print("My #\(rank) favorite band is \(band)")
}
numFavBand("Coldplay", rank: 4)
 ...
 */
// write your code here
func madLib(characterName: String, preposition: String, noun: String){
    print("To " + noun + " and " + preposition + ", \(characterName)")
}

madLib("Buzz", preposition: "beyond", noun: "infinity")
...
func catchPhraseBuzz(characterName: String) -> String {
    return "To infinity and beyond, \(characterName.uppercaseString)!"
    //Why doesn't it autocomplete in the <>?
}
print(catchPhraseBuzz("Jasmine"))
